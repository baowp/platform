...
public class MessageDAOImpl extends BaseDAOImpl implements MessageDAO {
	...
	public AbcMessage findById(String id) {
		...
		try {
			AbcMessage instance = (AbcMessage)super.findById(AbcMessage.class, id);
			return instance;
	...
	public List<AbcMessage> findByExample(AbcMessage instance) {
		...
		try {
			List<AbcMessage> results = (List<AbcMessage>) super.findByExample(instance);
	...
	public List<AbcMessage> findAll() {
		...
		try {
			return (List<AbcMessage>)super.findAll(AbcMessage.class);
		} catch (RuntimeException re) {
