...
public class MailtemplateDAOImpl extends BaseDAOImpl implements MailtemplateDAO {

	private static final Log log = LogFactory.getLog(MailtemplateDAOImpl.class);
	...
	public AbcMailtemplate findById(String id) {
		...
		try {
			AbcMailtemplate instance = (AbcMailtemplate)super.findById(AbcMailtemplate.class, id);
			return instance;
	...
	public List<AbcMailtemplate> findByExample(AbcMailtemplate instance) {
		...
		try {
			List<AbcMailtemplate> results = (List<AbcMailtemplate>) super.findByExample(instance);
	...
	public List<AbcMailtemplate> findAll() {
		...
		try {
			return (List<AbcMailtemplate>)super.findAll(AbcMailtemplate.class);
		} catch (RuntimeException re) {
