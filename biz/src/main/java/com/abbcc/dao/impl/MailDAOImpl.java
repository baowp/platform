...
public class MailDAOImpl extends BaseDAOImpl implements MailDAO {
	...
	public AbcMail findById(String id) {
		...
		try {
			AbcMail instance = (AbcMail)super.findById(AbcMail.class, id);
			return instance;
	...
	public List<AbcMail> findByExample(AbcMail instance) {
		...
		try {
			List<AbcMail> results = (List<AbcMail>) super.findByExample(instance);
	...
	public List<AbcMail> findAll() {
		...
		try {
			return (List<AbcMail>)super.findAll(AbcMail.class);
		} catch (RuntimeException re) {
