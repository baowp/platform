...
public class CellbindDAOImpl extends BaseDAOImpl implements CellbindDAO {
	private static final Log log = LogFactory.getLog(CellbindDAOImpl.class);
	...
	public AbcCellbind findById(String id) {
		...
		try {
			AbcCellbind instance = (AbcCellbind)super.findById(AbcCellbind.class, id);
			return instance;
	...
	public List<AbcCellbind> findByExample(AbcCellbind instance) {
		...
		try {
			List<AbcCellbind> results = (List<AbcCellbind>) super.findByExample(instance);
	...
	public List<AbcCellbind> findAll() {
		...
		try {
			return (List<AbcCellbind>)super.findAll(AbcCellbind.class);
		} catch (RuntimeException re) {
