...
public class DomainbindDAOImpl extends BaseDAOImpl implements DomainbindDAO {
	private static final Log log = LogFactory.getLog(DomainbindDAOImpl.class);
	...
	public AbcDomainbind findById(String id) {
		...
		try {
			AbcDomainbind instance = (AbcDomainbind)super.findById(AbcDomainbind.class, id);
			return instance;
	...
	public List<AbcDomainbind> findByExample(AbcDomainbind instance) {
		...
		try {
			List<AbcDomainbind> results = (List<AbcDomainbind>) super.findByExample(instance);
	...
	public List<AbcDomainbind> findAll() {
		...
		try {
			return (List<AbcDomainbind>)super.findAll(AbcDomainbind.class);
		} catch (RuntimeException re) {
