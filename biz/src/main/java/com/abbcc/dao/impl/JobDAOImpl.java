...
public class JobDAOImpl extends BaseDAOImpl implements JobDAO {
	...
	public AbcJob findById(String id) {
		...
		try {
			AbcJob instance = (AbcJob)super.findById(AbcJob.class, id);
			return instance;
	...
	public List<AbcJob> findByExample(AbcJob instance) {
		...
		try {
			List<AbcJob> results = (List<AbcJob>) super.findByExample(instance);
	...
	public List<AbcJob> findAll() {
		...
		try {
			return (List<AbcJob>)super.findAll(AbcJob.class);
		} catch (RuntimeException re) {
