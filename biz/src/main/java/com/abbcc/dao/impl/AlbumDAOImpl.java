...
public class AlbumDAOImpl extends BaseDAOImpl implements AlbumDAO {
	...
	public AbcAlbum findById(String id) {
		...
		try {
			AbcAlbum instance = (AbcAlbum)super.findById(AbcAlbum.class, id);
			return instance;
	...
	public List<AbcAlbum> findByExample(AbcAlbum instance) {
		...
		try {
			List<AbcAlbum> results = (List<AbcAlbum>) super.findByExample(instance);
	...
	public List<AbcAlbum> findAll() {
		...
		try {
			return (List<AbcAlbum>)super.findAll(AbcAlbum.class);
		} catch (RuntimeException re) {
