...
public class RecycleDAOImpl extends BaseDAOImpl implements RecycleDAO {
	private static final Log log = LogFactory.getLog(RecycleDAOImpl.class);
	...
	public AbcRecycle findById(String id) {
		...
		try {
			AbcRecycle instance = (AbcRecycle)super.findById(AbcRecycle.class, id);
			return instance;
	...
	public List<AbcRecycle> findByExample(AbcRecycle instance) {
		...
		try {
			List<AbcRecycle> results = (List<AbcRecycle>) super.findByExample(instance);
	...
	public List<AbcRecycle> findAll() {
		...
		try {
			return (List<AbcRecycle>)super.findAll(AbcRecycle.class);
		} catch (RuntimeException re) {
