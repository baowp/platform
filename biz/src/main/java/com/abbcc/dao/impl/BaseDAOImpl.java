...
public class BaseDAOImpl implements BaseDAO {
	...
	@SuppressWarnings({ "unchecked", "rawtypes", "deprecation", "deprecation" })
...
/*		org.hibernate.Query hibQuery = fullTextSession.createFullTextQuery(
		...
		org.apache.lucene.search.Sort sort = new Sort(new SortField(null, SortField.DOC, true));
	...
	public static void main(String[] args) throws ParseException {
		String[] name = { "title" };
		List list = new BaseDAOImpl().findUserByParams(name, "小", AbcJob.class);
		/*
		 * List list = new BaseDAOImpl() .findByHql("from AbcCertificate where
		 * gender=1");
		 */
		// List list = new BaseDAOImpl().findUserByParams({"name"},"name",
		// AbcEnterprise.class);
		LOG.info(list.size());
	}
