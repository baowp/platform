...
public class EnterpriseDAOImpl extends BaseDAOImpl implements EnterpriseDAO {
	...
	public AbcEnterprise findById(String id) {
		...
		try {
			AbcEnterprise instance = (AbcEnterprise)super.findById(AbcEnterprise.class, id);
			return instance;
	...
	public List<AbcEnterprise> findByExample(AbcEnterprise instance) {
		...
		try {
			List<AbcEnterprise> results = (List<AbcEnterprise>) super.findByExample(instance);
	...
	public List<AbcEnterprise> findAll() {
		...
		try {
			return (List<AbcEnterprise>)super.findAll(AbcEnterprise.class);
		} catch (RuntimeException re) {
