...
public class ViewlogDAOImpl extends BaseDAOImpl implements ViewlogDAO {

	private static final Log log = LogFactory.getLog(ViewlogDAOImpl.class);
	...
	public AbcViewlog findById(String id) {
		...
		try {
			AbcViewlog instance = (AbcViewlog)super.findById(AbcViewlog.class, id);
			return instance;
	...
	public List<AbcViewlog> findByExample(AbcViewlog instance) {
		...
		try {
			List<AbcViewlog> results = (List<AbcViewlog>) super.findByExample(instance);
	...
	public List<AbcViewlog> findAll() {
		...
		try {
			return (List<AbcViewlog>)super.findAll(AbcViewlog.class);
		} catch (RuntimeException re) {
...
//				Criteria crit = session.createCriteria(instance.getClass());
				...
				if (startCalendar != null)
					crit.add(Restrictions.gt("viewTime", startCalendar));
				if (endCalendar != null)
					crit.add(Restrictions.lt("viewTime", endCalendar));
