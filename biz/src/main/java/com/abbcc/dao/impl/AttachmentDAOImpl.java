...
public class AttachmentDAOImpl extends BaseDAOImpl implements AttachmentDAO {
	...
	public AbcAttachment findById(String id) {
		...
		try {
			AbcAttachment instance = (AbcAttachment)super.findById(AbcAttachment.class, id);
			return instance;
	...
	public List<AbcAttachment> findByExample(AbcAttachment instance) {
		...
		try {
			List<AbcAttachment> results = (List<AbcAttachment>) super.findByExample(instance);
	...
	public List<AbcAttachment> findAll() {
		...
		try {
			return (List<AbcAttachment>)super.findAll(AbcAttachment.class);
		} catch (RuntimeException re) {
