...
public class LinkDAOImpl extends BaseDAOImpl implements LinkDAO {
	...
	public AbcLink findById(String id) {
		...
		try {
			AbcLink instance = (AbcLink)super.findById(AbcLink.class, id);
			return instance;
	...
	public List<AbcLink> findByExample(AbcLink instance) {
		...
		try {
			List<AbcLink> results = (List<AbcLink>) super.findByExample(instance);
	...
	public List<AbcLink> findAll() {
		...
		try {
			return (List<AbcLink>)super.findAll(AbcLink.class);
		} catch (RuntimeException re) {
