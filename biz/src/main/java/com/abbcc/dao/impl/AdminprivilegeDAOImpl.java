...
public class AdminprivilegeDAOImpl extends BaseDAOImpl implements
		AdminprivilegeDAO {

	private static final Log log = LogFactory.getLog(AdminprivilegeDAOImpl.class);
	...
	public AbcAdminprivilege findById(String id) {
		...
		try {
			AbcAdminprivilege instance = (AbcAdminprivilege)super.findById(AbcAdminprivilege.class, id);
			return instance;
	...
	public List<AbcAdminprivilege> findByExample(AbcAdminprivilege instance) {
		...
		try {
			List<AbcAdminprivilege> results = (List<AbcAdminprivilege>) super.findByExample(instance);
	...
	public List<AbcAdminprivilege> findAll() {
		...
		try {
			return (List<AbcAdminprivilege>)super.findAll(AbcAdminprivilege.class);
		} catch (RuntimeException re) {
