...
public class DomainregDAOImpl extends BaseDAOImpl implements DomainregDAO {

	private static final Log log = LogFactory.getLog(DomainregDAOImpl.class);
	...
	public AbcDomainreg findById(String id) {
		...
		try {
			AbcDomainreg instance = (AbcDomainreg)super.findById(AbcDomainreg.class, id);
			return instance;
	...
	public List<AbcDomainreg> findByExample(AbcDomainreg instance) {
		...
		try {
			List<AbcDomainreg> results = (List<AbcDomainreg>) super.findByExample(instance);
	...
	public List<AbcDomainreg> findAll() {
		...
		try {
			return (List<AbcDomainreg>)super.findAll(AbcDomainreg.class);
		} catch (RuntimeException re) {
