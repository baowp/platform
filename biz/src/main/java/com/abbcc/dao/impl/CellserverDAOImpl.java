...
public class CellserverDAOImpl extends BaseDAOImpl implements CellserverDAO {

	private static final Log log = LogFactory.getLog(CellserverDAOImpl.class);
	...
	public AbcCellserver findById(String id) {
		...
		try {
			AbcCellserver instance = (AbcCellserver)super.findById(AbcCellserver.class, id);
			return instance;
	...
	public List<AbcCellserver> findByExample(AbcCellserver instance) {
		...
		try {
			List<AbcCellserver> results = (List<AbcCellserver>) super.findByExample(instance);
	...
	public List<AbcCellserver> findAll() {
		...
		try {
			return (List<AbcCellserver>)super.findAll(AbcCellserver.class);
		} catch (RuntimeException re) {
