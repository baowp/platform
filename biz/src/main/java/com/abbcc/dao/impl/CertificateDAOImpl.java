...
public class CertificateDAOImpl extends BaseDAOImpl implements CertificateDAO {
	...
	public AbcCertificate findById(String id) {
		...
		try {
			AbcCertificate instance = (AbcCertificate)super.findById(AbcCertificate.class, id);
			return instance;
	...
	public List<AbcCertificate> findByExample(AbcCertificate instance) {
		...
		try {
			List<AbcCertificate> results = (List<AbcCertificate>) super.findByExample(instance);
	...
	public List<AbcCertificate> findAll() {
		...
		try {
			return (List<AbcCertificate>)super.findAll(AbcCertificate.class);
		} catch (RuntimeException re) {
