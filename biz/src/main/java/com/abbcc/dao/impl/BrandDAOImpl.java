...
public class BrandDAOImpl extends BaseDAOImpl implements BrandDAO {
	...
	private static final Log log = LogFactory.getLog(BrandDAOImpl.class);
	...
	public AbcBrand findById(String id) {
		...
		try {
			AbcBrand instance = (AbcBrand)super.findById(AbcBrand.class, id);
			return instance;
	...
	public List<AbcBrand> findByExample(AbcBrand instance) {
		...
		try {
			List<AbcBrand> results = (List<AbcBrand>) super.findByExample(instance);
	...
	public List<AbcBrand> findAll() {
		...
		try {
			return (List<AbcBrand>)super.findAll(AbcBrand.class);
		} catch (RuntimeException re) {
