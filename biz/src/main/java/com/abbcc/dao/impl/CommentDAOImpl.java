...
import com.abbcc.dao.CommentDAO;
...
public class CommentDAOImpl extends BaseDAOImpl implements CommentDAO {
	 ...
	 */
	public void save(AbcComment transientInstance) {
		super.save(transientInstance);
		}
	/**
	 * 删除
	 */
	public void delete(AbcComment persistentInstance) {
	 ...
	 * @return
	 */
	public AbcComment findById(String id) {
		log.debug("getting Object instance with id: " + id);
		try {
			AbcComment instance = (AbcComment)super.findById(AbcComment.class, id);
			return instance;
	...
	public List<AbcComment> findByExample(AbcComment instance) {
		log.debug("finding Object instance by example");
		try {
			List<AbcComment> results = (List<AbcComment>) super.findByExample(instance);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<AbcComment> findAll() {
		log.debug("finding all Object instances");
		try {
			return (List<AbcComment>)super.findAll(AbcComment.class);
		} catch (RuntimeException re) {
	 ...
	 * @param instance
	 */
	public void saveOrUpdate(AbcComment instance) {
