...
public class UsergroupDAOImpl extends BaseDAOImpl implements UsergroupDAO {
	...
	public AbcUsergroup findById(String id) {
		...
		try {
			AbcUsergroup instance = (AbcUsergroup)super.findById(AbcUsergroup.class, id);
			return instance;
	...
	public AbcUsergroup loadById(AbcUsergroup persistentInstance,String id) {
		try {
			super.loadById(persistentInstance, id);
	...
	public List<AbcUsergroup> findByExample(AbcUsergroup instance) {
		...
		try {
			List<AbcUsergroup> results = (List<AbcUsergroup>) super.findByExample(instance);
	...
	public List<AbcUsergroup> findAll() {
		...
		try {
			return (List<AbcUsergroup>)super.findAll(AbcUsergroup.class);
		} catch (RuntimeException re) {
