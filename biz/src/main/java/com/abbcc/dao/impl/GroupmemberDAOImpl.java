...
public class GroupmemberDAOImpl extends BaseDAOImpl implements GroupmemberDAO {

	private static final Log log = LogFactory.getLog(GroupmemberDAOImpl.class);
	...
	public AbcGroupmember findById(String id) {
		...
		try {
			AbcGroupmember instance = (AbcGroupmember)super.findById(AbcGroupmember.class, id);
			return instance;
	...
	public List<AbcGroupmember> findByExample(AbcGroupmember instance) {
		...
		try {
			List<AbcGroupmember> results = (List<AbcGroupmember>) super.findByExample(instance);
	...
	public List<AbcGroupmember> findAll() {
		...
		try {
			return (List<AbcGroupmember>)super.findAll(AbcGroupmember.class);
		} catch (RuntimeException re) {
