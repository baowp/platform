...
public class EnterpcontactDAOImpl extends BaseDAOImpl implements
		EnterpcontactDAO {

	private static final Log log = LogFactory.getLog(EnterpcontactDAOImpl.class);
	...
	public AbcEnterpcontact findById(String id) {
		...
		try {
			AbcEnterpcontact instance = (AbcEnterpcontact)super.findById(AbcEnterpcontact.class, id);
			return instance;
	...
	public List<AbcEnterpcontact> findByExample(AbcEnterpcontact instance) {
		...
		try {
			List<AbcEnterpcontact> results = (List<AbcEnterpcontact>) super.findByExample(instance);
	...
	public List<AbcEnterpcontact> findAll() {
		...
		try {
			return (List<AbcEnterpcontact>)super.findAll(AbcEnterpcontact.class);
		} catch (RuntimeException re) {
