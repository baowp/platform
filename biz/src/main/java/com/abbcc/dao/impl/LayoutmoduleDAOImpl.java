...
public class LayoutmoduleDAOImpl extends BaseDAOImpl implements LayoutmoduleDAO {

	private static final Log log = LogFactory.getLog(LayoutmoduleDAOImpl.class);
	...
	public AbcLayoutmodule findById(String id) {
		...
		try {
			AbcLayoutmodule instance = (AbcLayoutmodule)super.findById(AbcLayoutmodule.class, id);
			return instance;
	...
	public List<AbcLayoutmodule> findByExample(AbcLayoutmodule instance) {
		...
		try {
			List<AbcLayoutmodule> results = (List<AbcLayoutmodule>) super.findByExample(instance);
	...
	public List<AbcLayoutmodule> findAll() {
		...
		try {
			return (List<AbcLayoutmodule>)super.findAll(AbcLayoutmodule.class);
		} catch (RuntimeException re) {
