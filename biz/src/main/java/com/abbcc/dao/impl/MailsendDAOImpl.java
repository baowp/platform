...
public class MailsendDAOImpl extends BaseDAOImpl implements MailsendDAO {

	private static final Log log = LogFactory.getLog(MailsendDAOImpl.class);
	...
	public AbcMailsend findById(String id) {
		...
		try {
			AbcMailsend instance = (AbcMailsend)super.findById(AbcMailsend.class, id);
			return instance;
	...
	public List<AbcMailsend> findByExample(AbcMailsend instance) {
		...
		try {
			List<AbcMailsend> results = (List<AbcMailsend>) super.findByExample(instance);
	...
	public List<AbcMailsend> findAll() {
		...
		try {
			return (List<AbcMailsend>)super.findAll(AbcMailsend.class);
		} catch (RuntimeException re) {
