...
public class SupplyDAOImpl extends BaseDAOImpl implements SupplyDAO {
	private static final Log log = LogFactory.getLog(SupplyDAOImpl.class);
	...
	public AbcSupply findById(String id) {
		...
		try {
			AbcSupply instance = (AbcSupply)super.findById(AbcSupply.class, id);
			return instance;
	...
	public List<AbcSupply> findByExample(AbcSupply instance) {
		...
		try {
			List<AbcSupply> results = (List<AbcSupply>) super.findByExample(instance);
	...
	public List<AbcSupply> findAll() {
		...
		try {
			return (List<AbcSupply>)super.findAll(AbcSupply.class);
		} catch (RuntimeException re) {
