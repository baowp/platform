...
public class SyscodeDAOImpl extends BaseDAOImpl implements SyscodeDAO {

	private static final Log log = LogFactory.getLog(SyscodeDAOImpl.class);
	...
	public AbcSyscode findById(String id) {
		...
		try {
			AbcSyscode instance = (AbcSyscode)super.findById(AbcSyscode.class, id);
			return instance;
	...
	public List<AbcSyscode> findByExample(AbcSyscode instance) {
		...
		try {
			List<AbcSyscode> results = (List<AbcSyscode>) super.findByExample(instance);
	...
	public List<AbcSyscode> findAll() {
		...
		try {
			return (List<AbcSyscode>)super.findAll(AbcSyscode.class);
		} catch (RuntimeException re) {
