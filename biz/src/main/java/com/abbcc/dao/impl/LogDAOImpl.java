...
public class LogDAOImpl extends BaseDAOImpl implements LogDAO {
	...
	private static final Log log = LogFactory.getLog(LogDAOImpl.class);

	/**
	 * 保存
	 * @param transientInstance
	 */
	public void save(AbcLog transientInstance) {
		super.save(transientInstance);
		}
	/**
	 * 删除
	 */
	public void delete(AbcLog persistentInstance) {
	 ...
	 * @return
	 */
	public AbcLog findById(String id) {
		log.debug("getting Object instance with id: " + id);
		try {
			AbcLog instance = (AbcLog)super.findById(AbcLog.class, id);
			return instance;
	...
	public List<AbcLog> findByExample(AbcLog instance) {
		log.debug("finding Object instance by example");
		try {
			List<AbcLog> results = (List<AbcLog>) super.findByExample(instance);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<AbcLog> findAll() {
		log.debug("finding all Object instances");
		try {
			return (List<AbcLog>)super.findAll(AbcLog.class);
		} catch (RuntimeException re) {
	 ...
	 * @param instance
	 */
	public void saveOrUpdate(AbcLog instance) {
