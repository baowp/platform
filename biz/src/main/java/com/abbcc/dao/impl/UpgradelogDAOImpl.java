...
public class UpgradelogDAOImpl extends BaseDAOImpl implements UpgradelogDAO {
	...
	private static final Log log = LogFactory.getLog(UpgradelogDAOImpl.class);
	...
	public AbcUpgradelog findById(String id) {
		...
		try {
			AbcUpgradelog instance = (AbcUpgradelog)super.findById(AbcUpgradelog.class, id);
			return instance;
	...
	public List<AbcUpgradelog> findByExample(AbcUpgradelog instance) {
		...
		try {
			List<AbcUpgradelog> results = (List<AbcUpgradelog>) super.findByExample(instance);
	...
	public List<AbcUpgradelog> findAll() {
		...
		try {
			return (List<AbcUpgradelog>)super.findAll(AbcUpgradelog.class);
		} catch (RuntimeException re) {
