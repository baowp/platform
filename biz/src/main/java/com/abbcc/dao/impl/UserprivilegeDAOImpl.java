...
public class UserprivilegeDAOImpl extends BaseDAOImpl implements
		UserprivilegeDAO {
	...
	public AbcUserprivilege findById(String id) {
		...
		try {
			AbcUserprivilege instance = (AbcUserprivilege)super.findById(AbcUserprivilege.class, id);
			return instance;
	...
	public List<AbcUserprivilege> findByExample(AbcUserprivilege instance) {
		...
		try {
			List<AbcUserprivilege> results = (List<AbcUserprivilege>) super.findByExample(instance);
	...
	public List<AbcUserprivilege> findAll() {
		...
		try {
			return (List<AbcUserprivilege>)super.findAll(AbcUserprivilege.class);
		} catch (RuntimeException re) {
