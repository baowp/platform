	${action.pieceCompetitiveProducts()}
	<#assign products=action.root.competitiveProducts>
		<div id="competitiveProducts" class="bodyCont moveChild glare_type_1">
			<div class="clr"></div>
			<div class="bodyContTitle">
				<span class="fl b titleLinkColor titleName" >
					${extract(layout.jsonContent['title'][enums["com.abbcc.util.constant.layout.Piece"].MAIN_COMPETITIVE_PRODUCTS.name()],
						moduleMap[enums["com.abbcc.util.constant.layout.Piece"].MAIN_COMPETITIVE_PRODUCTS.name()])}
				</span>
