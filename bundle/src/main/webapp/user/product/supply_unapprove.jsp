...
<div class="listTab">
	...
	<dl class="focus"><dt></dt>审核未通过<dt></dt></dl>
...
<s:iterator value="pageList.items">
	<tr>
		...
		<td  align="center"><a href="edit?id=${supplyId}&back=showunapprove">修改</a>
			<a href="remove?id=${supplyId}&back=showunapprove"><img src="/user/images/pic22.gif" alt="删除" title="删除"/></a>
		</td>
	</tr>
</s:iterator>
	<tfoot>
