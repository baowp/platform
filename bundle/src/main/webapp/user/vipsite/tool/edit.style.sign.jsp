...
<div class="uncheck" id="editTopContent">
	...
	<div style="height: 426px;">
		...
		<div class="contCont">
			...
			<div class="mt3px clr">
				<label class="fl typeLabel">上传背景图片：</label><span class="gray">建议尺寸952x90像素，大小200k内，jpg或gif格式</span><br>
				<s:form enctype="multipart/form-data" method="POST" target="uploadFrame" cssStyle="margin: 0px; display: inline;" namespace="/laytach" action="sign">
                    <s:hidden name="belongId"/>
                   	<s:hidden name="callback"/>
                    <s:file name="upload" cssClass="ml20px fl" size="27" id="uploadTopicBgFile"/>
                	<s:submit value="上传" onclick="return window.upload.sign(this.form);" cssClass="fl"/>
    			</s:form>&nbsp;
