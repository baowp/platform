								...
								.uploadify(
										{
											...
											'script' : '/commonutil/uploadUtil',
											'scriptData' : {
												'id' : '${albumId}',
												'username' : '${username}'
											},
											'buttonImg' : '/user/vipsite/album/images/insertPic01.jpg',
											'width' : 84,
											'height' : 25,
											...
											'simUploadLimit' : 100, //一次同步上传的文件数目
...
<body>
	...
	<div class="picMain">
			...
			<div class="right">
				...
				<s:if test="pageType==1">
					<img src="/user/vipsite/album/images/return01.jpg"
						onclick="javascript:window.location='/user/album/albumshowUploadPage?pageType=xheditor'" />
				</s:if>
				<s:elseif test="pageType==3">
				<img src="/user/vipsite/album/images/return01.jpg"
						onclick="javascript:window.location='/user/album/albumshowUploadPage'" />
				</s:elseif>
				<s:else>
					<img src="/user/vipsite/album/images/return01.jpg"
						onclick="javascript:window.location='/user/album/albumopen?id=${albumInfo.albumId}'" />
		...
		<div class="picContent">
			<div class="picborder">
				<div id="fileQueue"
					style="width: 100%; min-height: 200px; overflow-y: auto;"></div>
				...
				<table>
					<tr>
						...
						<td>
							<div id="fileQueue"
								style="width: 100%; height: 100%; overflow-y: auto;"></div></td>
					</tr>
					<tr>
						<td></td>
					</tr>
