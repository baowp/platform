...
<div class="bodyCont moveChild mainTextColor">
	<s:hidden name="piece" value="%{@com.abbcc.util.constant.layout.Piece@PRODUCT_SIMPLE2}"/>
    ...
    <div class="summary">
        <div class="gallery gallery-r">
			...
			<ul class="thumb clearfix" id="UlThumb">
				<li class="selected">
					<div class="pic s40 glitzPic glitzBorder glitzColor">
