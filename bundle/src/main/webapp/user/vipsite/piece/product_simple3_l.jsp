...
<link type="text/css" href="/user/vipsite/css/product.simple_l_r.css" rel="stylesheet" />
...
<div class="bodyCont moveChild mainTextColor">
	<s:hidden name="piece" value="%{@com.abbcc.util.constant.layout.Piece@PRODUCT_SIMPLE3}"/>
