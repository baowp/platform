	...
	<div id="confirm_main">
		<div id="confirm_left">
			...
			<div class="cl_navigation">
				<ul>
					<li><img alt="01" src="/user/upgrade/images/number_gray01.png"><a
						href="user/upgrade/versionselect.jsp"><span>版本选择</span></a>
					</li>
					<li><img alt="->" src="/user/upgrade/images/point02.png"><img
						alt="02" src="/user/upgrade/images/number_gray02.png"><a href="/user/upgrade/confirm"><span>确认信息
					</span></a>
					</li>
					<li><img alt="->" src="/user/upgrade/images/point01.png"><img
						alt="03" src="/user/upgrade/images/number03.png"><span><b>去银行（柜台或网站）付款</b></span>
					</li>
			...
			<div class="ccl">
					...
					<input type="radio" name="bank" checked="checked" title="农业银行" value="AgriculturalBank"/><img src="/user/upgrade/images/bank01.jpg" style=" vertical-align: middle;"/><br>
					<input type="radio" name="bank"  title="建设银行" value="ConstructionBank"/><img src="/user/upgrade/images/bank02.jpg" style=" vertical-align: middle;"/><br/>
					<br>
					<input type="button" value="打开支付页面" id="bankselect"/>
				</div>
				<div class="ccr">
					<ul>
