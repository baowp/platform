...
<s:include value="include/product_top.jsp"></s:include>
</div>
<div class="sou">
...
<s:include value="include/topEnt.jsp"></s:include>
</div>
<div class="advav"><img src="/user/free_user/images/03.jpg"
	width="224" height="70" /></div>
</div>
<div class="hj">
<div class="contain">
...
<ul>
	<s:iterator value="products.items">
		<li>
		<p class="hn"><a href="/site/${user.username}/product_detail?productId=${productId}"
			target="_blank"><img
			src="<s:property value="mainPic.picUrl(5)"/>" width="90" height="92"
			border="0" /></a></p>
		<p class="nh"><a href="/site/${user.username}/product_detail?productId=${productId}"
			target="_blank"><s:if test="name.length()<8">${name}</s:if><s:else><s:property value="name.substring(0,8)"/></s:else></a></p>
		</li>
	</s:iterator>
</ul>
</div>
...
<div class="company">
<div class="company_top">公司名片</div>
