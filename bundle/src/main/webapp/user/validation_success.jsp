...
<div id="u">
  <div id="to">
    <div class="top_left"><img src="/user/images/logo.png" width="163" height="47" /></div>
    <div class="top_right"><span class="font2"><a href="http://51archetype.com" target="_parent">返回首页</a></span><br />
        <span class="font2">如遇问题请拨打 </span><span class="font01">0579-87171989</span></div>
  </div>
  <div id="cont">
    <div class="h_nav">用户验证</div>
	
    <div id="c_content">
      <div class="c_top">
        <div class="c_01"><img src="images/Head1239.gif" width="96" height="96" /></div>
        <div class="c_02">
          <h3 class="h3">恭喜你，验证成功!</h3>
          <h4 class="h4">您目前已经可以正常使用东方五金网了。</h4>
          <h4 class="h4"><strong>友情提示：</strong>我们请尽快去完善您的个人信息，这样有便于商友更好的发现您</h4>
        </div>
      </div>
      <div class="c_center"></div>
      <div class="c_top">
        <div class="c_01"><a href="http:51archetype.comcc.net/user/login.jsp">马上登陆</a></div>
