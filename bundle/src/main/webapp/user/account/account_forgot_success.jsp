...
<div id="nar">
  ...
  <div id="cen">
    <table width="100%" height="188" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="25" colspan="2" align="left" valign="top"><div class="mac"><span class="font04">找回登录名/密码</span> <img src="/user/images/0.gif" width="16" height="16" /> <span class="font04">填写注册邮箱 </span>》<img src="/user/images/2.gif" width="16" height="16" /> <span class="font04">填写资料 》</span><img src="/user/images/03.gif" width="16" height="16" /><span class="font02">找回成功</span></div></td>
      </tr>
      <tr>
        <td width="48%" valign="top"><table width="100%" border="0" cellpadding="0">
            <tr>
              <td width="86%" height="31" align="right" class="font04">您的用户名或密码已经发到你的安全邮箱了，请走查收！</td>
              <td width="14%" align="left">&nbsp;</td>
            </tr>
            <tr>
              <td height="31" align="right" class="font04">&nbsp;</td>
              <td align="left">&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
