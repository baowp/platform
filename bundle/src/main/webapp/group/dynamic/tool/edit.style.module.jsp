		...
		<div id="titleBgList" class="contCont">
			...
			<div class="clr">
				...
				<div id="imgList2" class="backgroundImgBox disabled clr">
					<ul>
						<c:forEach items="${titleBgSet }" var="bg">
							<li><a href="#"><img class="uncheck2 {selector:'.bodyContTitle',property:'background'}" height="30" width="30" src="${bg }"></a></li>
						</c:forEach>
					</ul>
				</div>
			</div>
			<div class="mt3px">
				...
				<div style="margin: 0px; display: inline;">
					<input class="ml20px" size="27" id="uploadTitleBgFile" readonly="readonly" type="text"> 
					<a class="various3" style="display: inline;" href="/user/album/albumshowUploadPage?valueId=uploadTitleBgFile&callback=upload.titleDid">选择图片</a>
				</div>
				<div class="clr"></div>
			</div>
		</div>
