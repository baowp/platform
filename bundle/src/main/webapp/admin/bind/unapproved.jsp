...
<body>
<s:form action="unapproved" method="get">
	<div id="nav">
		<ul>
			<li class="bg_image_onclick" id="man_nav_1">审核不通过的域名</li>
			...
			<table cellspacing="1" cellpadding="3" border="0" align="center" width="99%" id="tablesorter">
				...
				<tbody>
					...
					<tr class='{"id":"${bindId}"}'>
						...
						<td>
							<a href="javascript:approve()" class="operate">通过</a>
							<a href="javascript:detail()" class="operate">详细</a>
						</td>
					</tr>
					</s:iterator>
				</tbody>
