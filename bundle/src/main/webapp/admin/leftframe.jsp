...
<body onload="initinav('个人设置')">
<div id="left_content">
<div id="user_info">欢迎您， <strong>${sessionScope.abbccadmin.name}</strong>
<br />
[ <a href="#"><s:property
	value="#session.abbccadmin.adminTypename()" /></a>， <a
	href="javascript:logout()">退出</a>]</div>
<div id="main_nav">
