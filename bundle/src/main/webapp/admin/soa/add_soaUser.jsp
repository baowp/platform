...
<div id="nav">
<ul>
	<li id="man_nav_1" class="bg_image_onclick">添加网站</li>
</ul>
</div>
<div id="sub_info">
<div id="man_zone"><s:if test="result!=''&&result!=null">
	<div id="warning">${result}</div>
</s:if> <s:form namespace="/admin" action="addUserSite" method="post"
	id="form1">
	<table width="99%" border="0" align="center" cellpadding="3"
		cellspacing="1" class="table_style">
		<s:hidden name="state" value="01"></s:hidden>
		<tr>
			<td width="120px" class="left_title_1"><span class="left-title">用户名</span>
			</td>
			<td><s:textfield name="username" /><span
				class="errorSpan">${errors.username[0]}</span></td>
		</tr>
		<tr>
			<td width="120px" class="left_title_1"><span class="left-title">域名</span>
			</td>
			<td><s:textfield name="domain"  size="50"/><span
				class="errorSpan">${errors.domain[0]}</span></td>
		</tr>
		<tr>
			<td width="120px" class="left_title_1"><span class="left-title">所属服务器</span>
			</td>
			<td><s:select list="%{#session.webservers}"
				name="serverId" listKey="serverId" listValue="name" /><span
				class="errorSpan">${errors.serverId[0]}</span></td>
		</tr>
		<tr>
			<td width="120px" class="left_title_1"><span class="left-title">网站部署路径</span>
			</td>
			<td><s:textfield name="folder" size="50"/><span
