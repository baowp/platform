...
<s:form namespace="/admin" action="searchSupply" method="post"
	...
	<table width="99%" border="0" align="center" cellpadding="3"
		...
		<thead>
			<tr>
				<th class="header">帮助主题</th>
				<th class="header">添加时间</th>
				<th class="header">添加用户</th>
			</tr>
		</thead>
			<tr>
				<td><s:property value="helpTitle()" /></td>
			...
			<tr>
				<td colspan="4" style="word-wrap:break-word;width:100%;overflow:auto"><s:property escape="false" value="helpContent()" /></td>
			</tr>
		</tbody>
		<tfoot>
			<tr>
