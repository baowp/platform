...
<s:form namespace="/admin" action="searchSupply" method="post"
	...
	<ul>
		<li id="man_nav_1" class="bg_image_onclick">公告详细</li>
	...
	<table width="99%" border="0" align="center" cellpadding="3"
		...
		<thead>
			<tr>
				<th class="header">公告栏目</th>
				<th class="header">添加时间</th>
				<th class="header">添加人</th>
			</tr>
		</thead>
			<tr>
			...
			<tr>
				<td colspan="3" style="word-wrap:break-word;width:100%;overflow:auto"><s:property escape="false" value="content" /></td>
			</tr>
		</tbody>
		<tfoot>
			<tr>
				<th colspan="3" class="tb_search">
				<button type="button" id="close" class="delete">关闭</button>
				</th>
			</tr>
		</tfoot>
	</table>
