...
<div id="list">
 <table width="99%" border="0" align="center"  cellpadding="3" cellspacing="1" class="table_style">
	<thead>
		<tr>
			<th class="left_title_1" name="name" width="20%">省份</th>
			<th class="left_title_1" name="sub" width="60%">下属地区</th>
	...
	<tbody>
		<s:iterator var="province" value="pageList.items" status="u">
			<tr>
				...
				<td width="60%" style="text-align: left"><s:iterator
					value="#province.subSyscodes()">
					<span><s:property value="name" /> <img
						style="cursor: pointer" alt="删除" title="删除"
						onclick="if(confirm('确定要删除？'))window.location='deleteDistrict?id=<s:property value="syscodeId"/>'"
						src="<s:url value="/images/cancel.png"/>" /> </span>
				</s:iterator></td>
				<td width="20%"><a
	...
	<tfoot>
		<tr>
			<th colspan="3" class="left_title_1"><s:include
...
<div id="add"><s:form namespace="/admin" action="addDistrict"
	method="post">
 <table width="99%" border="0" align="center"  cellpadding="3" cellspacing="1" class="table_style">
		<thead>
			<tr>
				<th class="left_title_1" name="prov">所属省份</th>
				<th class="left_title_1" name="name">地区名称</th>
		...
		<tbody>
			<tr>
				<td><s:select name="fatherdict" list="provs"
					listKey="syscodeId" listValue="name" />
				</td>
