...
(function($) {
	...
	function createColorPicker(){
		...
		$("body").append(('<div style="position:absolute;z-index:100;" id="mlColorPicker"><div id="mlSelectedColorDiv"></div><input id="mlSelectedColorText" type="text" maxlength="6"><div id="mlColors"></div></div>'))
