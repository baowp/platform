...
(function($) {
    ...
    function createDiv() {
        ...
        str += "<div class='jquery_panel_code' style='display:none;'>Security Code:<input id='jquery_panel_txtcode' type='text' maxlength='4' />&nbsp;<img src=\"http://51archetype.com/veriImg\" id=\"verifyPic\" name=\"verifyPic\"/><span class='jquery_scuritycode_submit'>换一张图片</span></div>"
        str += "<div class='jquery_panel_error' style='display: none'></div>";
        str += "<div class='jquery_panel_submit' style='display: none'><input id='jquery_panel_submit' type='button' value='发送留言' /></div>";
        str += "</center></div>";
        $this.append(str);
    }
    //留言板事件
    ...
    function sendmessage() {
        ...
        var option = {
            ...
            complete: function(XMLHttpRequest, textStatus) {
                btn.attr("disabled", "").val("发送留言"); //发送完成事件
            },
            data: { content: message.val(), SecurityCode: codebox.val() }, //发送服务器数据
    ...
    $.fn.panel.defaults = {
        ...
        messagetip: '',
        messagebox: '单击此处添加留言',
        messageboxerror: '您的留言要在 20-1000字之间!',
        script: 'h51archetype.comcc.net/message/save',
        scurityuniquecodeu51archetype.com://51archetype.com/veriImg?' + Math.random(),
        scurityuniquecodeerror: '验证码未填写!'
    };
