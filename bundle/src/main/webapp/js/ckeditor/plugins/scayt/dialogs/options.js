...
CKEDITOR.dialog
		.add(
				'scaytcheck',
				function(a) {
					var b = true, c, d = CKEDITOR.document, e = [], f, g = [], h = false, i = [
							'dic_create,dic_restore', 'dic_rename,dic_delete' ], j = [
							'mixedCase', 'mixedWithDigits', 'allCaps',
							'ignoreDomainNames' ];
					function k() {
					...
					var n = [
							...
							{
								id : 'langs',
								label : a.lang.scayt.languagesTab,
								elements : [ {
									type : 'html',
									id : 'langs',
							...
							{
								id : 'dictionaries',
								label : a.lang.scayt.dictionariesTab,
								elements : [ {
									type : 'html',
									style : '',
									id : 'dictionaries',
