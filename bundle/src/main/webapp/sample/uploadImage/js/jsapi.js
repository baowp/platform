...
if (!window['google']['loader']) {
			...
			if (b) {
				if (P[x] == 0) {
					...
					if (!E("msie") && !(E("safari") || E("konqueror"))
							&& E("mozilla") || l.opera)
						l.addEventListener("DOMContentLoaded", S, h);
					else if (E("msie"))
						o
			...
			if (c[x]) {
				...
				if (!b && O[":" + this.a] != g
					...
					for ( var R in c.properties)
						if (R && R[s](0) == ":")
							google[this.a][R[B](1)] = c.properties[R];
	...
	google.loader.rfm({
		...
		":earth" : {
			...
			"path" : "/api/earth/1.0/c37eaccce6874ff6fce172dec6c34cbe/",
			"js" : "default.I.js",
			"properties" : {
				":JSHash" : "c37eaccce6874ff6fce172dec6c34cbe",
				":Version" : "1.0"
			}
		},
		":annotations" : {
			...
			"path" : "/api/annotations/1.0/a4bafe7a8752af35cdba60ba39230b9d/",
			"js" : "default+en.I.js",
			"properties" : {
				":JSHash" : "a4bafe7a8752af35cdba60ba39230b9d",
				":Version" : "1.0"
			}
		}
	});
