...
<div class="sm_c">
<div class="hk"><a
	href="http://cn.easthardware.net/user/account/account_forgot_page.jsp?pageType=1"
	target="_blank">找回用户名</a><a href="#"></a></div>
<div class="hk"><a
	href="http://cn.easthardware.net/user/account/account_forgot_page.jsp?pageType=2"
	target="_blank">找回密码</a><a href="#"></a></div>
<div class="hk"><a
	href="http://cn.easthardware.net/user/platform/index.jsp" target="_blank">修改联系方式</a><a
	href="#"></a></div>
<div class="hk"><a href="http://www.ykit.net/Contact1.html"
	target="_blank">东方五金在线</a><a href="#"></a></div>
<div class="hk"><a
	href="http://cn.easthardware.net/user/platform/index.jsp" target="_blank">修改服务授权</a><a
	href="#"></a></div>
<div class="hk"><a href="http://im.qq.com/qq/2010/standard/"
	target="_blank">在线安装QQ</a><a href="#"></a></div>
</div>
<div class="sm">菜单分类</div>
<div class="sm_c">
<s:action name="treeMenu" namespace="/kefu" executeResult="true"></s:action>
</div>
<div class="contract">
...
<div class="hu">
<div class="right" style="height:373px">
<iframe id="mainFrame" style="OVERFLOW: visible" height="100%"
	src="rightFrame.html" frameBorder=0 width="100%" name=main
	scrolling=yes></iframe>
</div>
<div class="gu"><a href="http://www.ykit.net/" target="_blank"><img
	src="images/guanggao.gif" width="705" height="70" border="0" /></a></div>
</div></div>
<div id="copryright">
<ul class="ij">
